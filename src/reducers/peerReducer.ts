...
import { ADD_PEER_STREAM, REMOVE_PEER_STREAM, ADD_PEER_NAME, ADD_ALL_PEERS } from "./peerActions";

export type PeerState = Record<string, { stream?: MediaStream; userName?: string; peerId: string }>;
type PeerAction =
  | {
